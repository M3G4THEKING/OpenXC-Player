<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
               <a class="main-logo" href="painel.php?sessao=<?php echo gerar_hash(256); ?>"><img style="height:80px;" src="assets/<?php echo $template; ?>/img/logo-player.png" class="main-logo img-responsive" alt="<?php echo NOME_IPTV; ?>" title="<?php echo NOME_IPTV; ?>"></a>
            </div>
