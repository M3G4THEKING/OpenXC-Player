...
define('HOME_TEXTO_BEMVINDO','Welcome to webplayer login below using your details.');
define('HOME_BOTAO_LOGIN','Log in');
define('HOME_BOTAO_LOGIN','Log in');
...
define('HOME_TXT_TESTE','Free trail');
define('HOME_TXT_TESTE_DESC','Sign up and free test');
...
define('ERROR_FORMATO_VIDEO_DESC','Sorry for this inconvenience some browsers still do not support all available video formats.');

define('TXT_DESCRICAO_ASSINATURA','Payments through Bank Slip may take up to 24 business hours to be approved and confirmed by the issuing bank. Tuesday to Saturday Compensation.');
